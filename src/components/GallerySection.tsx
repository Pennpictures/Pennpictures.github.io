...
import galleryCouple2 from "@/assets/gallery-couple2.jpg";
...
const galleryImages: GalleryImage[] = [
  ...
  {
    src: galleryWedding,
    alt: "Beautiful wedding ceremony walking down the aisle",
  ...
  {
    src: galleryCouple,
    alt: "Romantic couple embrace at Corney Island",
  ...
  {
    src: galleryPet,
    alt: "Smiling Pomeranian dog outdoors",
